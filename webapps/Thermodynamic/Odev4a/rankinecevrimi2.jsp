...
<%!
   ...
   final String TableName="Odev4a_2";
...
<FORM action="<%=response.encodeURL("rankinecevrimi2.jsp")%>" method="POST" onSubmit="return checkDigitSeperator(this)">
  <P align=center> 
  <TABLE style="HEIGHT: 61px" cellSpacing=1 cellPadding=1 width=370 
border=1>
    <TBODY bgColor=aqua>
      <TR> 
        <TD width=152><font face="Comic Sans MS">%Kuruluk Derecesi=</font></TD>
        <TD width="144" align=middle><font face="Comic Sans MS"> 
          <INPUT name=useranswer0>
          </font></TD>
        <TD width=56>&nbsp;</TD>
      </TR> 
      <TD width=152><font face="Comic Sans MS">%Verim=</font></TD>
        <TD width="144" align=middle><font face="Comic Sans MS"> 
      ...
      <TR> 
        <TD width=152><font face="Comic Sans MS">Sorunun de�eri=</font></TD>
        <TD align=middle><font face="Comic Sans MS"><%=strvalueforquestion%></font></TD>
        <TD width=56><font face="Comic Sans MS">puan</font></TD>
      </TR>
    </TBODY>
  </TABLE>
