...
<%!
   ...
   final String TableName="Odev2_1";
...
<%
  ...
  if(!IsValuesGiven){
   ...
   dbc.updateString("STUDENTNUMBER",username,"SystemAnswer2",TableName,String.valueOf(RH));
 }else{
   for(int i=0;i<values.length;i++){
...
<P align=center><font color="#ff0080" size="5" face="Comic Sans MS"><STRONG>Psikrometrik 
  De�erleri Bulma-1</STRONG></font></P>
<P align="justify"><font face="Comic Sans MS">Size verilen Kuru Termometre S�cakl���=<%=T%>�C, Ya� Termometre S�cakl���=<%=Tyas%>�C ve Bas�n�=<%=P%> (kPa) de�erlerini kullanarak,</font></P>
<P align="justify"><font face="Comic Sans MS"> A) Mutlak Nemi (gr su/kg kuru hava),<br>
  B) Ba��l Nemi (%) hesaplay�n�z.</font></P>
<P align=center><font face="Comic Sans MS"><STRONG>CEVAPLAMA B�L�M�</STRONG></font></P>
<FORM action="<%=response.encodeURL("psikrometritablo.jsp")%>" method="POST" onSubmit="return checkDigitSeperator(this)">
  <P align=center> 
  <TABLE style="HEIGHT: 61px" cellSpacing=1 cellPadding=1 width=390 
border=1>
    <TBODY bgColor=aqua>
      <TR> 
        <TD width=125><font face="Comic Sans MS">Mutlak Nem=</font></TD>
        <TD width="144" align=middle><font face="Comic Sans MS">
          <INPUT name=useranswer0>
          </font></TD>
        <TD width=103><font face="Comic Sans MS">gr su/kg kh</font></TD>
      </TR>
	  <TR> 
        <TD width=125><font face="Comic Sans MS">Ba��l Nem=</font></TD>
        <TD width="144" align=middle><font face="Comic Sans MS">
          <INPUT name=useranswer1>
          </font></TD>
        <TD width=103><font face="Comic Sans MS">%</font></TD>
      </TR>
      <TR> 
        <TD colSpan=3> <P 
      ...
      <TR> 
        <TD width=125><font face="Comic Sans MS">Sorunun de�eri=</font></TD>
        <TD align=middle><font face="Comic Sans MS"><%=strvalueforquestion%></font></TD>
        <TD width=103><font face="Comic Sans MS">puan</font></TD>
      </TR>
    </TBODY>
  </TABLE>
