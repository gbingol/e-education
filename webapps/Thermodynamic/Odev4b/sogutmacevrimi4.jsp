...
<%!
   ...
   final String TableName="Odev4b_4";
...
<FORM action="<%=response.encodeURL("sogutmacevrimi4.jsp")%>" method="POST" onSubmit="return checkDigitSeperator(this)">
  <P align=center> 
