...
<%
  ...
  final String TableName[]={"Odev4b_1","Odev4b_2","Odev4b_3","Odev4b_4","Odev4b_5"};
  final String SoruAdi[]={"So�utma �evrimi-1","So�utma �evrimi-2","So�utma �evrimi-3","So�utma �evrimi-4","So�utma �evrimi-5"};
