...
<%!
   ...
   final String TableName="Odev1a_1";
...
<%
  ...
  if(!IsValuesGiven){
        ...
        h=(double)(int)(Math.random()*150+100);		//cm cinsinden y�kseklik
   		double varr=r/100,varh=h/100;
        A=2.0*Math.PI*Math.pow(varr,2.0)+2.0*Math.PI*varr*varh;
        V=Math.PI*Math.pow(varr,2.0)*varh;
		//
       values[0]=r;values[1]=h;
      //
      //
...
%>
<P align=center><font face="Comic Sans MS"><STRONG><FONT size=5 color="#ff0080">S�L�ND�R</FONT></STRONG></font></P>
<table width="100%" border="0">
  <tr>
    <td width="60%"><P align="justify"><font face="Comic Sans MS">Yar��ap� <%=r%> 
        (cm) ve y�ksekli�i <%=h%> (cm) olan silindirin, </font></P>
      <P align="justify"><font face="Comic Sans MS"> A) Y�zey alan�n� (m<sup>2</sup>)<br>
        B) Hacmini (m<sup>3</sup>) hesaplay�n�z.</font></P>
</td>
    <td width="40%"><img src="/images/Silindir.gif" width="229" height="128" align="middle"></td>
  </tr>
</table>
<P align="justify">&nbsp;</P>
<P align=center><font face="Comic Sans MS"><STRONG>CEVAPLAMA B�L�M�</STRONG></font></P>
<FORM action="<%=response.encodeURL("silindir.jsp")%>" method="POST" onSubmit="return checkDigitSeperator(this)">
  <P align=center> 
