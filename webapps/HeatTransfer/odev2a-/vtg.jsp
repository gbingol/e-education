...
<%
  ...
  final String TableName[]={"2a_KritikCap","2a_BORUICINDEHAVA","2a_SinirTabaka","2a_ColburnAnalojisi"};
  final String SoruAdi[]={"Kritik �ap","Boru ��inde Hava","S�n�r Tabaka","Colburn Analojisi"};
