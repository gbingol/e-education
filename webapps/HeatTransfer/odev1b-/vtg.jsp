...
<%
  ...
  final String TableName[]={"1b_Conduction6","1b_HomeDesign","1b_Radyator","1b_KizginBuharBorusu"};
  final String SoruAdi[]={"Topun So�umas�","Odadan Olan Is� Kayb�","Radyator","Kizgin Buhar Borusu"};
