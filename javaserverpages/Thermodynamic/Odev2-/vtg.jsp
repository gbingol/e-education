...
<%
  ...
  final String TableName[]={"Odev2_1","Odev2_2","Odev2_3","Odev2_4"};
  final String SoruAdi[]={"Psikrometrik Tablo Okuma-1","Psikrometrik Tablo Okuma-2","�nsan Konforu ve �klimlendirme","Serpantin �zerinden Akan Hava"};
