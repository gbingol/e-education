...
<%!
   ...
   final String TableName="Odev4a_1";
...
<%
  ...
  if(!IsValuesGiven){
		...
		do{
          ...
          Tturbin=(double)(int)(Math.random()*200+300);
       ...
       //
          ...
          for(int i=0;i<values.length;i++){
            ...
            String TableToSet="Odev4a_"+String.valueOf(j);
			//Insert names into table then insert their values
			try
			{
				String SQLQuery="INSERT INTO "+TableToSet+" (NAME_SURNAME,STUDENTNUMBER) "+" VALUES ('"+name_surname+"',"+"'"+username+"')";
				dbc.runSQL(SQLQuery);
			}catch(Exception e){}
			//now insert the values
            dbc.updateString("STUDENTNUMBER",username,ColumnToSet,TableToSet,String.valueOf(values[i]));
          }
...
<FORM action="<%=response.encodeURL("rankinecevrimi.jsp")%>" method="POST" onSubmit="return checkDigitSeperator(this)">
  <P align=center> 
  <TABLE style="HEIGHT: 61px" cellSpacing=1 cellPadding=1 width=370 
border=1>
    <TBODY bgColor=aqua>
      <TR> 
        <TD width=149><font face="Comic Sans MS">%Kuruluk Derecesi=</font></TD>
        <TD width="146" align=middle><font face="Comic Sans MS"> 
          <INPUT name=useranswer0>
          </font></TD>
        <TD width=57>&nbsp;</TD>
      </TR> 
      <TD width=149><font face="Comic Sans MS">%Verim=</font></TD>
        <TD width="146" align=middle><font face="Comic Sans MS"> 
      ...
      <TR> 
        <TD width=149><font face="Comic Sans MS">Sorunun de�eri=</font></TD>
        <TD align=middle><font face="Comic Sans MS"><%=strvalueforquestion%></font></TD>
        <TD width=57><font face="Comic Sans MS">puan</font></TD>
      </TR>
    </TBODY>
  </TABLE>
