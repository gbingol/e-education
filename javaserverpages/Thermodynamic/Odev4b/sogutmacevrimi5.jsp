...
<%!
   ...
   final String TableName="Odev4b_5";
...
<%
  ...
  if(!IsValuesGiven){
      ...
      P2=P3;              //MPa
      double temps,tempT=Tevaporator;
	  do{
        tempT=tempT+1;
        temps=shfluid.s(P2,tempT);
      }while(!(Math.abs(temps-s2)<0.1));
      T2=tempT;
      h2=shfluid.h(P2,T2);
      Qyog=h2-h3;
      Qevap=h1-h4;
...
<FORM action="<%=response.encodeURL("sogutmacevrimi5.jsp")%>" method="POST" onSubmit="return checkDigitSeperator(this)">
  <P align=center> 
