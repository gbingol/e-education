...
<%!
   ...
   final String TableName="Odev1b_6";
...
<%
  ...
  if(!IsValuesGiven){
   ...
   dbc.updateString("STUDENTNUMBER",username,"SystemAnswer1",TableName,String.valueOf(hwater));
   dbc.updateString("STUDENTNUMBER",username,"SystemAnswer2",TableName,String.valueOf(swater));
   dbc.updateString("STUDENTNUMBER",username,"SystemAnswer3",TableName,String.valueOf(vR12));
   dbc.updateString("STUDENTNUMBER",username,"SystemAnswer4",TableName,String.valueOf(hR12));
   dbc.updateString("STUDENTNUMBER",username,"SystemAnswer5",TableName,String.valueOf(sR134A));
 }else{
   for(int i=0;i<values.length;i++){
...
function checkDigitSeperator(frm)
{
	...
	for(i=0;i<formElements.length;i++)
	{
		...
		while(txtValue.charAt(j)!="")
		{
			...
			if(validchars.indexOf(txtValue.charAt(j))<0) 
			{
			alert(txtValue.charAt(j)+" numerik degildir. Numerik karakter girmelisiniz");
			isSubmit=false;
			return false;
			}
			j++;
...
<FORM action="<%=response.encodeURL("tableevaluation.jsp")%>" method="POST" onSubmit="return checkDigitSeperator(this)">
  <table width="80%" border="1">
    <tr> 
      <td width="14%"><div align="center"><font color="#FF0000" face="Comic Sans MS"><strong>AKI�KAN</strong></font></div></td>
      <td width="20%"><div align="center"><font color="#FF0000" face="Comic Sans MS"><strong>SICAKLIK 
          �C </strong></font></div></td>
      <td width="16%"><div align="center"><font color="#FF0000" face="Comic Sans MS"><strong>BASIN� 
          (kPa)</strong></font></div></td>
      <td width="38%"><div align="center"><font color="#FF0000" face="Comic Sans MS"><strong>KURULUK 
          DERECES� (%)</strong></font></div></td>
      <td width="38%"><div align="center"><font color="#FF0000"><strong><font face="Comic Sans MS">BULUNACAK 
          �ZEL�K </font></strong></font></div></td>
      <td width="12%"><div align="center"><font color="#FF0000"><strong><font face="Comic Sans MS">CEVAPLA</font></strong></font></div></td>
    </tr>
    <tr> 
      <td><div align="center"><font face="Comic Sans MS">Su</font></div></td>
      ...
      <td><div align="center"><font face="Comic Sans MS"> 
          <input name="Water_1" type="submit" id="Water_1" value="Cevapla">
          </font></div></td>
    </tr>
    <tr> 
      <td><div align="center"><font face="Comic Sans MS">Su</font></div></td>
      ...
      <td><div align="center"><font face="Comic Sans MS"> 
          <input name="Water_2" type="submit" id="Water_2" value="Cevapla">
          </font></div></td>
    </tr>
    <tr> 
      ...
      <td><div align="center"><font face="Comic Sans MS"> 
          <input name="R12_1" type="submit" value="Cevapla">
          </font></div></td>
    </tr>
    <tr> 
      <td><div align="center"><font face="Comic Sans MS">R-12</font></div></td>
      ...
      <td><div align="center"><font face="Comic Sans MS"> 
          <input name="R12_2" type="submit" id="R12_2" value="Cevapla">
          </font></div></td>
    </tr>
    <tr> 
      ...
      <td><div align="center"><font face="Comic Sans MS"> 
          <input name="R134A" type="submit" id="R134A" value="Cevapla">
          </font></div></td>
    </tr>
  </table>
</FORM>
...
class Grade
{
    ...
    void GradeIt(JspWriter out,String results)
 {
      ...
      if(numberofanswer.equals(""))  {
        numberofanswer="1";
        dbc.updateString("STUDENTNUMBER",username,strNumberofAnswer,TableName,String.valueOf(1));
      }
      int intnumberofanswer=Integer.valueOf(numberofanswer).intValue();
      //
      try{
        if(!isanswered){
          ...
          String strvalueforquestion=String.valueOf(doublevalueforquestion);
          intnumberofanswer++;
          dbc.updateString("STUDENTNUMBER",username,strNumberofAnswer,TableName,String.valueOf(intnumberofanswer)); //
     	  String ColumnToSet="UserAnswer"+String.valueOf(rownumber)+"_"+String.valueOf(intnumberofanswer-1);
		  dbc.updateString("STUDENTNUMBER",username,ColumnToSet,TableName,String.valueOf(useranswer));
          //
          ...
          dbc.updateString("STUDENTNUMBER",username,StringNOTU,TableName,String.valueOf(ara_puan));
		  //
		  for(int i=1;i<=5;i++)
		  {
