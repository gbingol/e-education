...
<%
  ...
  final String TableName[]={"1a_Conduction1","1a_Conduction2","1a_Conduction3","1a_celikboru","1a_DirencinYuzeySicakligi","1a_SonsuzLevha"};
  final String SoruAdi[]={"Bak�r Levha","�elik Levha","Duvardan Is� Kayb�","�elik Borudan Is� Kayb�","Direncin Y�zey S�cakl���","Sonsuz Levha"};
