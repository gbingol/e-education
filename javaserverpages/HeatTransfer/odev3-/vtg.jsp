...
<%
  ...
  final String TableName[]={"3_BORUDANDOGALTASINIM","3_ISINIMKALKANI","3_ISITRANSFERKATSAYISI","3_SOMINE","3_SILINDIRIKMETALELEMAN"};
  final String SoruAdi[]={"Borudan Do�al Ta��n�m","I��n�m Kalkan�","Is� Transfer Katsay�s�","��mine","Silindirik Metal Eleman"};
