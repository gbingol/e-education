...
<%!
   ...
   final String TableName="PSYCHROMETRICCALCULATION2";
...
<%
  ...
  if(!IsValuesGiven){
   ...
   dbc.updateString("Number",username,"SystemAnswer1",TableName,String.valueOf(Td));
   dbc.updateString("Number",username,"SystemAnswer2",TableName,String.valueOf(P));
 }else{
   for(int i=0;i<values.length;i++){
...
<P align=center><font color="#ff0080" size="5" face="Comic Sans MS"><STRONG>Psychrometric 
  Calculation-2</STRONG></font></P>
<P align="justify"><font face="Comic Sans MS">Given </font><font face="Comic Sans MS"> 
  Dry Bulb Temperature=<%=T%>�C, Wet Bulb Temperature=<%=Tyas%>�C ve Enthalpy=<%=h%> (kJ/kg) find,</font></P>
<P align="justify"><font face="Comic Sans MS"> A) Dew Point Temperature (�C),<br>
  B) Pressure (kPa).</font></P>
<P align=center><font face="Comic Sans MS"><STRONG>ANSWERING SECTION</STRONG></font></P>
<FORM action="<%=response.encodeURL("psikrometritablo2.jsp")%>" method="POST">
  <P align=center> 
  <TABLE style="HEIGHT: 61px" cellSpacing=1 cellPadding=1 width=493 
border=1>
    <TBODY bgColor=aqua>
      <TR> 
        <TD width=214><font face="Comic Sans MS">Dew Point Temperature=</font></TD>
        <TD width="144" align=middle><font face="Comic Sans MS">
          <INPUT name=useranswer0>
          </font></TD>
        <TD width=117><font face="Comic Sans MS">�C</font></TD>
      </TR>
	  <TR> 
        <TD width=214><font face="Comic Sans MS">Pressure=</font></TD>
        <TD width="144" align=middle><font face="Comic Sans MS">
          <INPUT name=useranswer1>
          </font></TD>
        <TD width=117><font face="Comic Sans MS">kPa</font></TD>
      </TR>
      <TR> 
        <TD colSpan=3> <P 
      ...
      <TR> 
        <TD width=214><font face="Comic Sans MS">Value of question=</font></TD>
        <TD align=middle><font face="Comic Sans MS"><%=strvalueforquestion%></font></TD>
        <TD width=117><font face="Comic Sans MS">points</font></TD>
      </TR>
    </TBODY>
  </TABLE>
