...
public class PsikrometriForm extends java.applet.Applet{
	...
	public void init()
	{
		...
		MyDigit=new Choice();
		MyDigit.resize(7,7);
		MyDigit.addItem("1 Digit");
		MyDigit.addItem("2 Digit");
		MyDigit.addItem("3 Digit");
		MyDigit.addItem("4 Digit");
		MyDigit.addItem("6 Digit");
		...
		chP.addItem("Atm");
		chP.addItem("Bar");
		chP.addItem("Psia");//Bas�n� se�im listesi 
		chP.addItem("mm-Hg");
		chP.addItem("inHg");
		chP.addItem("Torr");
		chP.addItem("lb/ft2");
		...
		chPw.addItem("Atm");
		chPw.addItem("Bar");
		chPw.addItem("Psia");//Pw se�im listesi 
		chPw.addItem("mm-Hg");
		chPw.addItem("inHg");
		chPw.addItem("Torr");
		chPw.addItem("lb/ft2");
		...
		chPws.addItem("Atm");
		chPws.addItem("Bar");
		chPws.addItem("Psia");//Pws se�im listesi 
		chPws.addItem("mm-Hg");
		chPws.addItem("inHg");
		chPws.addItem("Torr");
		chPws.addItem("lb/ft2");
		chPws.addItem("lb/in2");
		
		chPwsyas=new Choice();
		chPwsyas.setFont(MyFont);
		chPwsyas.addItem("Pa");
		chPwsyas.addItem("Atm");
		chPwsyas.addItem("Bar");
		chPwsyas.addItem("Psia");//Pwsyas se�im listesi 
		chPwsyas.addItem("mm-Hg");
		chPwsyas.addItem("inHg");
		chPwsyas.addItem("Torr");
		chPwsyas.addItem("lb/ft2");
		chPwsyas.addItem("lb/in2");
		...
		chW=new Choice();
		chW.setFont(MyFont);
		chW.addItem("kg water/kg dry air");
		chW.addItem("g water/kg dry air");
		
		chWs=new Choice();
		chWs.setFont(MyFont);
		chWs.addItem("kg water/kg dry air");
		chWs.addItem("g water/kg dry air");
		
		chWsyas=new Choice();
		chWsyas.setFont(MyFont);
		chWsyas.addItem("kg water/kg dry air");
		chWsyas.addItem("g water/kg dry air");
		...
		chHeight=new Choice();
		chHeight.setFont(MyFont);

		for(int i=0;i<struzunluk.length;i++)
		{
			chHeight.addItem(struzunluk[i]);
		}
		
		
		Font MyFont2=new Font("Arial",Font.BOLD,10);
		chkP=new Checkbox("P Pressure");
		chkP.setFont(MyFont2);
		chkP.setBackground(c);

		chkT=new Checkbox("T Dry-bulb Temperature");
		chkT.setFont(MyFont2);
		chkT.setBackground(c);

		chkTd=new Checkbox("TD Dew-point temperature");
		chkTd.setFont(MyFont2);
		chkTd.setBackground(c);

		chkTyas=new Checkbox("T* Wet-bulb temperature");
		chkTyas.setFont(MyFont2);
		chkTyas.setBackground(c);

		chkW=new Checkbox("W  Humidity Ratio");
		chkW.setFont(MyFont2);
		chkW.setBackground(c);

		chkH=new Checkbox("H  Entalphy");
		chkH.setFont(MyFont2);
		chkH.setBackground(c);

		chkRH=new Checkbox("RH  Relative Humidity");
		chkRH.setFont(MyFont2);
		chkRH.setBackground(c);
		...
		lblP=new Label("Pressure");
		lblP.setFont(MyFont2);

		lblPw=new Label("Pw");
		lblPw.setFont(MyFont2);
		lblPw.setAlignment(Label.RIGHT);

		lblPws=new Label("Pws");
		lblPws.setFont(MyFont2);
		lblPws.setAlignment(Label.RIGHT);

		lblPwsyas=new Label("Pws*");
		lblPwsyas.setFont(MyFont2);
		lblPwsyas.setAlignment(Label.RIGHT);

		lblT=new Label("Dry-bulb temperature");
		lblT.setFont(MyFont2);

		lblTd=new Label("Dew-point temperature");
		lblTd.setFont(MyFont2);

		lblTyas=new Label("Wet-bulb temperature");
		lblTyas.setFont(MyFont2);

		lblW=new Label("Humidity Ratio");
		lblW.setFont(MyFont2);

		lblWs=new Label("Ws");
		lblWs.setFont(MyFont2);
		lblWs.setAlignment(Label.RIGHT);

		lblWsyas=new Label("Ws*");
		lblWsyas.setFont(MyFont2);
		lblWsyas.setAlignment(Label.RIGHT);

		lblH=new Label("Entalphy");
		lblH.setFont(MyFont2);

		lblRH=new Label("Humidity Ratio");
		lblRH.setFont(MyFont2);

		lblHeight=new Label("Altitude");
		lblHeight.setFont(MyFont2);
		lblHeight.setAlignment(Label.RIGHT);
	...
	public void TyasRhH(){
		//19 nolu kombinasyon	3 April 1999
	...
	public void TTyasP() throws NumberFormatException{
		//6 nolu kombinasyon	(3 October 1998)
		PsikrometrikFonksiyonlar pf=new PsikrometrikFonksiyonlar();
	...
	public void TTyasH(){
		//15 nolu kombinasyon	(3 October 1998)
		PsikrometrikFonksiyonlar pf=new PsikrometrikFonksiyonlar();
	...
	public void TyasTdP(){
		//16 nolu kombinasyon	(3 October 1998)
		PsikrometrikFonksiyonlar pf=new PsikrometrikFonksiyonlar();
	...
	public void TTyasW(){
		//10 nolu kombinasyon	(3 October 1998)
		PsikrometrikFonksiyonlar pf=new PsikrometrikFonksiyonlar();
	...
	public void TyasWH(){
		//22 nolu kombinasyon	(4 October 1998)
		PsikrometrikFonksiyonlar pf=new PsikrometrikFonksiyonlar();
	...
	public void TyasPH(){
		//24 nolu kombinasyon	(4 October 1998)
		PsikrometrikFonksiyonlar pf=new PsikrometrikFonksiyonlar();
	...
	public void TTyasTd(){
		// 1 nolu kombinasyon	(4 October 1998)
	...
	public void TTdP(){
		//2 nolu kombinasyon	(8 October 1998)
		PsikrometrikFonksiyonlar pf=new PsikrometrikFonksiyonlar();
		varT=OkuSicaklik(chT,txtT);
		varTd=OkuSicaklik(chTd,txtTd);
	...
	public void TWP(){
		//3 nolu kombinasyon	(10 October 1998)
	...
	public void TyasPW(){
		//17 nolu kombinasyon	(10 October 1998)
		PsikrometrikFonksiyonlar pf=new PsikrometrikFonksiyonlar();
		varTyas=OkuSicaklik(chTyas,txtTyas);
		varW=Double.valueOf(txtW.getText()).doubleValue();
		varW=varW*(1/(nemto[chW.getSelectedIndex()]));
	...
	public void TyasTdW(){
		//20 nolu kombinasyon	(11 October 1998)
		PsikrometrikFonksiyonlar pf=new PsikrometrikFonksiyonlar();
		varTyas=OkuSicaklik(chTyas,txtTyas);
		varTd=OkuSicaklik(chTd,txtTd);
	...
	public void TWRH(){
		//4 nolu kombinasyon	(11 October 1998)
		PsikrometrikFonksiyonlar pf=new PsikrometrikFonksiyonlar();
	...
	public void TRhH(){
		//5 nolu kombinasyon	(11 October 1998)
	...
	public void TTdW(){
		//7 nolu kombinasyon	(11 October 1998)
		PsikrometrikFonksiyonlar pf=new PsikrometrikFonksiyonlar();
	...
	public void TdWRh(){
		// 27 nolu kombinasyon	(27 February 1999)
		PsikrometrikFonksiyonlar pf=new PsikrometrikFonksiyonlar();
	...
	public void THP(){
		//12 nolu kombinasyon	(20 March 1999)
		PsikrometrikFonksiyonlar pf=new PsikrometrikFonksiyonlar();
	...
	public void THTd(){
		// 14 nolu kombinasyon	(20 March 1999)
		PsikrometrikFonksiyonlar pf=new PsikrometrikFonksiyonlar();
	...
	public void TdRhH(){
		//28 nolu kombinasyon	27 March 1999
		PsikrometrikFonksiyonlar pf=new PsikrometrikFonksiyonlar();
	...
	public void TdPRh(){
		//29 nolu kombinasyon	27 March 1999
		PsikrometrikFonksiyonlar pf=new PsikrometrikFonksiyonlar();
	...
	public void TdWH(){
		//30 nolu kombinasyon	27 March 1999
		PsikrometrikFonksiyonlar pf=new PsikrometrikFonksiyonlar();
		varTd=OkuSicaklik(chTd,txtTd);
	...
	public void TdPH(){
		//31 nolu kombinasyon	27 March 1999
		PsikrometrikFonksiyonlar pf=new PsikrometrikFonksiyonlar();
		varTd=OkuSicaklik(chTd,txtTd);
	...
	public void PWRh(){
		//32 nolu kombinasyon	28 March 1999
		PsikrometrikFonksiyonlar pf=new PsikrometrikFonksiyonlar();
	...
	public void PWH(){
		//34 nolu kombinasyon	28 March 1999
		PsikrometrikFonksiyonlar pf=new PsikrometrikFonksiyonlar();
	...
	public void WRhH(){
		//35 nolu kombinasyon	28 March 1999
		PsikrometrikFonksiyonlar pf=new PsikrometrikFonksiyonlar();
	...
	public void PRhH(){
		//33 nolu kombinasyon	28 March 1999
	...
	public void TTyasRh(){
		//13 nolu kombinasyon	29 March 1999
	...
	public void TyasTdRh(){
		//23 nolu kombinasyon	29 March 1999
		double a,b,c,d,e,f,G,h;
		PsikrometrikFonksiyonlar pf=new PsikrometrikFonksiyonlar();
		varTd=OkuSicaklik(chTd,txtTd);
		varTyas=OkuSicaklik(chTyas,txtTyas);
	...
	public void TyasTdH(){
		//25 nolu kombinasyon	30 March 1999
	...
	public void TyasRhP(){
		//21 nolu kombinasyon	30 March 1999
	...
	public void TyasWRh(){
		//18 nolu kombinasyon		10 April 1999
	...
	public void FindHeight(TextField TxtGet,TextField TxtSet){
		//Bas�nca kar��l�k gelen y�kseklikleri bulur	15 April 1997
		PsikrometrikFonksiyonlar pf=new PsikrometrikFonksiyonlar();
		int i;
		double PressureRead;
