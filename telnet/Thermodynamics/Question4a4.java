    ...
    public void GradeIt(DataOutputStream out,BufferedReader in,PrintWriter pw){
      ...
      try{
        if(!isanswered){
          ...
          pw.println("Kuruluk derecesi için "+mhtable.getCellValue(4,9)+" girdiniz");
          pw.println("Wturbin için "+mhtable.getCellValue(4,10)+" girdiniz");
          pw.println("Wpompa için "+mhtable.getCellValue(4,11)+" girdiniz");
          pw.println("Qkazan için "+mhtable.getCellValue(4,12)+" girdiniz");
          pw.println("%Verim için "+mhtable.getCellValue(4,13)+" girdiniz");
          double total=Double.valueOf(mhtable.getCellValue(4,14)).doubleValue ();
          pw.println("4. Sorudan toplam "+String.valueOf(total)+" aldýnýz.");
        }//else
