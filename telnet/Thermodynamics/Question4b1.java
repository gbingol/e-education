...
//***************************6th QUESTION*******************************
//
class Question4b1 extends Questions{
    ...
    if(str.equals("ValueIsGiven")) IsValuesGiven=true;
      if(!IsValuesGiven){
        ...
        //Tevaporator=-9;Kizdirma=0;Tyogunlastirici=38;AsiriSogutma=0;
        ...
        for(int j=6;j<=10;j++){
          for(int i=0;i<values.length;i++){
            if(j==7) values[1]=values[1]+5;
            if(j==8) values[3]=values[3]-5;
            if(j==9) values[0]=values[0]-10;
            if(j==10) values[2]=values[2]+10;
