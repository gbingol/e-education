...
//***************************5th QUESTION*******************************
//
class Question4a5 extends Questions{
    ...
    if(str.equals("ValueIsGiven")) IsValuesGiven=true;
      try{
        if(!IsValuesGiven){
          Tyog=Double.valueOf(mhtable.getCellValue(5,1)).doubleValue ();
          Tturbin=Double.valueOf(mhtable.getCellValue(5,2)).doubleValue ();
          Pturbin=Double.valueOf(mhtable.getCellValue(5,3)).doubleValue ();
    ...
    protected void CalculateWriteResults(){
        ...
        mhtable.setCellValue(5,4,String.valueOf(x4));mhtable.setCellNote(5,4,"Turbin cikisindaki kuruluk derecesi");
        mhtable.setCellValue(5,5,String.valueOf(Wturbin));mhtable.setCellNote(5,5,"Turbinden elde edilen is");
        mhtable.setCellValue(5,6,String.valueOf(Wpompa));mhtable.setCellNote(5,6,"Pompaya verilen is");
        mhtable.setCellValue(5,7,String.valueOf(Qkazan));mhtable.setCellNote(5,7,"Kazana verilmesi gerekli isi miktari");
        mhtable.setCellValue(5,8,String.valueOf(Verim));mhtable.setCellNote(5,8,"Cevrimin % de isil verimi");
    }
    public void GradeIt(DataOutputStream out,BufferedReader in,PrintWriter pw){
      ...
      double totalpoint=0;
      double varx=Double.valueOf(mhtable.getCellValue(5,4)).doubleValue();
      double varWturbin=Double.valueOf(mhtable.getCellValue(5,5)).doubleValue();
      double varWpompa=Double.valueOf(mhtable.getCellValue(5,6)).doubleValue();
      double varQkazan=Double.valueOf(mhtable.getCellValue(5,7)).doubleValue();
      double varVerim=Double.valueOf(mhtable.getCellValue(5,8)).doubleValue();
      ...
      try{
        if(!isanswered){
          ...
          updateCell(11,5,1);
          mhtable.setCellValue(5,9,String.valueOf(useranswer[0]));
          mhtable.setCellValue(5,10,String.valueOf(useranswer[1]));
          mhtable.setCellValue(5,11,String.valueOf(useranswer[2]));
          mhtable.setCellValue(5,12,String.valueOf(useranswer[3]));
          mhtable.setCellValue(5,13,String.valueOf(useranswer[4]));
          //
          ...
          if(useranswer[0]<upperlimit[0]&&useranswer[0]>lowerlimit[0]){
            ...
            mhtable.setCellNote(5,9,"Kullanicinin kuruluk derecesi icin cevabi");
          }else{mhtable.setCellValue(5,14,"0.000");}
          //
          if(useranswer[1]<upperlimit[1]&&useranswer[1]>lowerlimit[1]){
            totalpoint=totalpoint+doublevalueforquestion/5;
            pw.println(String.valueOf(useranswer[1])+" cevabiniz dogru.");
            mhtable.setCellNote(5,10,"Kullanicinin Wturbin icin cevabi");
          }else{mhtable.setCellValue(5,14,"0.000");}
          //
          if(useranswer[2]<upperlimit[2]&&useranswer[2]>lowerlimit[2]){
            totalpoint=totalpoint+doublevalueforquestion/5;
            pw.println(String.valueOf(useranswer[2])+" cevabiniz dogru.");
            mhtable.setCellNote(5,11,"Kullanicinin Wpompa icin cevabi");
          }else{mhtable.setCellValue(5,14,"0.000");}
          //
          if(useranswer[3]<upperlimit[3]&&useranswer[3]>lowerlimit[3]){
            totalpoint=totalpoint+doublevalueforquestion/5;
            pw.println(String.valueOf(useranswer[3])+" cevabiniz dogru.");
            mhtable.setCellNote(5,12,"Kullanicinin Qkazan icin cevabi");
          }else{mhtable.setCellValue(5,14,"0.000");}
          //
          if(useranswer[4]<upperlimit[4]&&useranswer[4]>lowerlimit[4]){
            totalpoint=totalpoint+doublevalueforquestion/5;
            pw.println(String.valueOf(useranswer[4])+" cevabiniz dogru.");
            mhtable.setCellNote(5,13,"Kullanicinin %Verim icin cevabi");
          }else{mhtable.setCellValue(5,14,"0.000");}
          //
          mhtable.setCellValue(5,14,String.valueOf(totalpoint));
          mhtable.setCellNote(5,14,"Kullanicinin bu soru icin toplam notu");
          //
          ...
          pw.println("Kuruluk derecesi için "+mhtable.getCellValue(5,9)+" girdiniz");
          pw.println("Wturbin için "+mhtable.getCellValue(5,10)+" girdiniz");
          pw.println("Wpompa için "+mhtable.getCellValue(5,11)+" girdiniz");
          pw.println("Qkazan için "+mhtable.getCellValue(5,12)+" girdiniz");
          pw.println("%Verim için "+mhtable.getCellValue(5,13)+" girdiniz");
          double total=Double.valueOf(mhtable.getCellValue(5,14)).doubleValue ();
