...
// Threads register themselves here thus can not make simultaneous multiple connections
  ...
  public static boolean acceptConnection=true;
  ...
  //
  public static boolean isStudentConnected(String username){
    if((Thread)connectedStudents.get(username)!=null) return true;
    return false;
  }
}
