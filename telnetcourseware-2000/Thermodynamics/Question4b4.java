...
//***************************9th QUESTION*******************************
//
class Question4b4 extends Questions{
    ...
    if(str.equals("ValueIsGiven")) IsValuesGiven=true;
      if(!IsValuesGiven){
         try{
          Tevaporator=Double.valueOf(mhtable.getCellValue(9,1)).doubleValue ();
          Kizdirma=Double.valueOf(mhtable.getCellValue(9,2)).doubleValue ();
          Tyogunlastirici=Double.valueOf(mhtable.getCellValue(9,3)).doubleValue ();
          AsiriSogutma=Double.valueOf(mhtable.getCellValue(9,4)).doubleValue ();
