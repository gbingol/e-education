...
//***************************3rd QUESTION*******************************
//
class Question4a3 extends Questions{
    ...
    if(str.equals("ValueIsGiven")) IsValuesGiven=true;
      try{
        if(!IsValuesGiven){
          Tyog=Double.valueOf(mhtable.getCellValue(3,1)).doubleValue ();
          Tturbin=Double.valueOf(mhtable.getCellValue(3,2)).doubleValue ();
          Pturbin=Double.valueOf(mhtable.getCellValue(3,3)).doubleValue ();
    ...
    protected void CalculateWriteResults(){
        ...
        mhtable.setCellValue(3,4,String.valueOf(x4));mhtable.setCellNote(3,4,"Turbin cikisindaki kuruluk derecesi");
        mhtable.setCellValue(3,5,String.valueOf(Wturbin));mhtable.setCellNote(3,5,"Turbinden elde edilen is");
        mhtable.setCellValue(3,6,String.valueOf(Wpompa));mhtable.setCellNote(3,6,"Pompaya verilen is");
        mhtable.setCellValue(3,7,String.valueOf(Qkazan));mhtable.setCellNote(3,7,"Kazana verilmesi gerekli isi miktari");
        mhtable.setCellValue(3,8,String.valueOf(Verim));mhtable.setCellNote(3,8,"Cevrimin % de isil verimi");
    }
    public void GradeIt(DataOutputStream out,BufferedReader in,PrintWriter pw){
      ...
      double varWturbin=Double.valueOf(mhtable.getCellValue(3,5)).doubleValue();
      double varWpompa=Double.valueOf(mhtable.getCellValue(3,6)).doubleValue();
      double varQkazan=Double.valueOf(mhtable.getCellValue(3,7)).doubleValue();
      double varVerim=Double.valueOf(mhtable.getCellValue(3,8)).doubleValue();
      ...
      try{
        if(!isanswered){
          ...
          mhtable.setCellValue(3,11,String.valueOf(useranswer[2]));
          mhtable.setCellValue(3,12,String.valueOf(useranswer[3]));
          mhtable.setCellValue(3,13,String.valueOf(useranswer[4]));
          //
          ...
          if(useranswer[0]<upperlimit[0]&&useranswer[0]>lowerlimit[0]){
            ...
            mhtable.setCellNote(3,9,"Kullanicinin kuruluk derecesi icin cevabi");
          }else{mhtable.setCellValue(3,14,"0.000");}
          //
          if(useranswer[1]<upperlimit[1]&&useranswer[1]>lowerlimit[1]){
            totalpoint=totalpoint+doublevalueforquestion/5;
            pw.println(String.valueOf(useranswer[1])+" cevabiniz dogru.");
            mhtable.setCellNote(3,10,"Kullanicinin Wturbin icin cevabi");
          }else{mhtable.setCellValue(3,14,"0.000");}
          //
          if(useranswer[2]<upperlimit[2]&&useranswer[2]>lowerlimit[2]){
            totalpoint=totalpoint+doublevalueforquestion/5;
            pw.println(String.valueOf(useranswer[2])+" cevabiniz dogru.");
            mhtable.setCellNote(3,11,"Kullanicinin Wpompa icin cevabi");
          }else{mhtable.setCellValue(3,14,"0.000");}
          //
          if(useranswer[3]<upperlimit[3]&&useranswer[3]>lowerlimit[3]){
            totalpoint=totalpoint+doublevalueforquestion/5;
            pw.println(String.valueOf(useranswer[3])+" cevabiniz dogru.");
            mhtable.setCellNote(3,12,"Kullanicinin Qkazan icin cevabi");
          }else{mhtable.setCellValue(3,14,"0.000");}
          //
          if(useranswer[4]<upperlimit[4]&&useranswer[4]>lowerlimit[4]){
            totalpoint=totalpoint+doublevalueforquestion/5;
            pw.println(String.valueOf(useranswer[4])+" cevabiniz dogru.");
            mhtable.setCellNote(3,13,"Kullanicinin %Verim icin cevabi");
          }else{mhtable.setCellValue(3,14,"0.000");}
          //
          mhtable.setCellValue(3,14,String.valueOf(totalpoint));
          mhtable.setCellNote(3,14,"Kullanicinin bu soru icin toplam notu");
          //
          ...
          pw.println("Kuruluk derecesi için "+mhtable.getCellValue(3,9)+" girdiniz");
          pw.println("Wturbin için "+mhtable.getCellValue(3,10)+" girdiniz");
          pw.println("Wpompa için "+mhtable.getCellValue(3,11)+" girdiniz");
          pw.println("Qkazan için "+mhtable.getCellValue(3,12)+" girdiniz");
          pw.println("%Verim için "+mhtable.getCellValue(3,13)+" girdiniz");
          double total=Double.valueOf(mhtable.getCellValue(3,14)).doubleValue ();
