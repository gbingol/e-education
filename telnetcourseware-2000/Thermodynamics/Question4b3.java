...
//***************************8th QUESTION*******************************
//
class Question4b3 extends Questions{
    ...
    if(str.equals("ValueIsGiven")) IsValuesGiven=true;
      if(!IsValuesGiven){
         try{
          Tevaporator=Double.valueOf(mhtable.getCellValue(8,1)).doubleValue ();
          Kizdirma=Double.valueOf(mhtable.getCellValue(8,2)).doubleValue ();
          Tyogunlastirici=Double.valueOf(mhtable.getCellValue(8,3)).doubleValue ();
          AsiriSogutma=Double.valueOf(mhtable.getCellValue(8,4)).doubleValue ();
