import java.io.*;
//
//*********************Uygulamada Taþýným 1. soru**********************
//
class Convection5 extends Questions{
    ...
    public void print(PrintWriter pw){
      pw.println("");
      pw.println("************************************************************************");
      pw.println(" T°C'de bulunan hava a*b (cm) boyutlarindaki Tlevha°C sicakliginda sabit");
      pw.println("tutulan levha uzerinden akmaktadir. Tasinim isi transfer katsayisi ");
      pw.println("h (W/m2°C)'dir. Isi transferi miktarini (W) hesaplayiniz.");
      pw.println("************************************************************************");
    }
    ...
    if(str.equals("ValueIsGiven")) IsValuesGiven=true;
      if(!IsValuesGiven){
        ...
        pw.println("a (cm)= "+String.valueOf(a));values[1]=a;
        pw.println("b (cm)= "+String.valueOf(b));values[2]=b;
        pw.println("Tlevha°C= "+String.valueOf(Tlevha));values[3]=Tlevha;
        pw.println("h (W/m2°C)= "+String.valueOf(h));values[4]=h;
        //
        ...
        a=values[1];pw.println("a (cm)= "+String.valueOf(a));
        b=values[2];pw.println("b (cm)= "+String.valueOf(b));
        Tlevha=values[3];pw.println("Tlevha°C= "+String.valueOf(Tlevha));
        h=values[4];pw.println("h (W/m2°C)= "+String.valueOf(h));
      }
    }
